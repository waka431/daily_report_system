...
public class EmployeeAction2 extends ActionBase {
    ...
    public void create() throws ServletException, IOException {
        ...
        if (checkAdmin() && checkToken()) { //追記
            ...
            if (errors.size() > 0) {
                ...
                putSessionScope(AttributeConst.FLUSH, MassageConst.I_REGISTERED.getMessage());
    ...
    public void update() throws ServletException, IOException {
        ...
        if (checkAdmin() && checkToken()) { //追記
            ...
            if (errors.size() > 0) {
                ...
                putSessionScope(AttributeConst.FLUSH, MassageConst.I_UPDATED.getMessage());
    ...
    public void destroy() throws ServletException, IOException {
        ...
        if (checkAdmin() && checkToken()) { //追記
            ...
            putSessionScope(AttributeConst.FLUSH, MassageConst.I_DELETED.getMessage());
